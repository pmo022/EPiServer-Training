...
CREATE TABLE [dbo].[tblApprovalDefinitionVersion] (
    ...
    [DemandCommentOnReject]  BIT            NOT NULL,
...
CREATE TABLE [dbo].[tblApprovalDefinitionApprover] (
    ...
    [Username]                      NVARCHAR (255) NOT NULL,
    [fkLanguageBranchID]            INT            NOT NULL,
    CONSTRAINT [PK_tblApprovalDefinitionApprover] PRIMARY KEY CLUSTERED ([pkID] ASC)
);


GO
PRINT N'Creating [dbo].[tblApprovalDefinitionApprover].[IDX_tblApprovalDefinitionApprover_Username]...';


GO
CREATE NONCLUSTERED INDEX [IDX_tblApprovalDefinitionApprover_Username]
    ON [dbo].[tblApprovalDefinitionApprover]([Username] ASC);
...
GO
PRINT N'Creating [dbo].[tblApproval].[IDX_tblApproval_ApprovalKey]...';


GO
CREATE NONCLUSTERED INDEX [IDX_tblApproval_ApprovalKey]
    ON [dbo].[tblApproval]([ApprovalKey] ASC);


GO
PRINT N'Creating [dbo].[tblApproval].[IDX_tblApproval_ApprovalStatus]...';


GO
CREATE NONCLUSTERED INDEX [IDX_tblApproval_ApprovalStatus]
    ON [dbo].[tblApproval]([ApprovalStatus] ASC);
...
ALTER TABLE [dbo].[tblApprovalDefinitionVersion]
    ADD DEFAULT (0) FOR [DemandCommentOnReject];
...
ALTER TABLE [dbo].[tblApprovalDefinitionStep]
    ADD DEFAULT (1) FOR [ApproversNeeded];
...
GO
PRINT N'Creating [dbo].[FK_tblApprovalDefinitionApprover_tblApprovalDefinitionStep]...';


GO
ALTER TABLE [dbo].[tblApprovalDefinitionApprover]
    ADD CONSTRAINT [FK_tblApprovalDefinitionApprover_tblApprovalDefinitionStep] FOREIGN KEY ([fkApprovalDefinitionStepID]) REFERENCES [dbo].[tblApprovalDefinitionStep] ([pkID]) ON DELETE CASCADE;


GO
PRINT N'Creating [dbo].[FK_tblApprovalDefinitionApprover_tblApprovalDefinitionVersion]...';


GO
ALTER TABLE [dbo].[tblApprovalDefinitionApprover]
    ADD CONSTRAINT [FK_tblApprovalDefinitionApprover_tblApprovalDefinitionVersion] FOREIGN KEY ([fkApprovalDefinitionVersionID]) REFERENCES [dbo].[tblApprovalDefinitionVersion] ([pkID]);


GO
PRINT N'Creating [dbo].[FK_tblApprovalDefinitionApprover_tblLanguageBranch]...';


GO
ALTER TABLE [dbo].[tblApprovalDefinitionApprover]
    ADD CONSTRAINT [FK_tblApprovalDefinitionApprover_tblLanguageBranch] FOREIGN KEY ([fkLanguageBranchID]) REFERENCES [dbo].[tblLanguageBranch] ([pkID]);
